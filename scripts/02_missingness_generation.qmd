...
### Discrete probabilities based on continuous weighted sum score quantiles
...
```{r}
#| label: fig-odds2
#| fig-cap: "Imposed missingness based on scaled weighted sum score and corresponding missingness probability."
#| 
odds_fit <- glm(
  isNA ~ wss,
  data = wss,
